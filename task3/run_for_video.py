...
config_file = 'E:\Projects\mmsegmentation\configs\segformer\segformer_mit-b5_8xb1-160k_cityscapes-1024x1024.py'
...
# 把每一帧串成视频文件
mmcv.frames2video(temp_out_dir, 'B3_video.mp4', fps=imgs.fps, fourcc='mp4v')
